...
interface DropdownProps {
  ...
  width?: "auto" | "trigger" | "full" | "trigger-auto" | string;
}
...
export function Dropdown({
  ...
  const getWidthClass = () => {
    ...
    if (width === "trigger") return "w-auto min-w-48";
    if (width === "trigger-auto") return "w-auto";
            ...
            {searchable && (
              <div className="p-3 border-b border-slate-200 dark:border-slate-600">
                <input
                  ...
                  className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-900 dark:text-white"
                  autoFocus
                />
              </div>
            )}
